...
Simple::Simple(const wxString& title):
    ...
    Connect(ID_reg, wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(Simple::Click1));
    button->SetFocus();
    button1 = new wxButton(this, ID_login, wxT("Log in"));
    Connect(ID_login, wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(Simple::Click1));
    button1->SetFocus();
    text1 = new wxStaticText(this, wxID_ANY, "Enter Username: ", wxPoint (10, 10), wxDefaultSize,
                                                  wxALIGN_CENTRE);
    text2 = new wxStaticText(this, wxID_ANY, "Enter Password: ", wxPoint (10, 10), wxDefaultSize,
                                                  wxALIGN_CENTRE);    
    ...
    Connect(wxID_EXIT, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(Simple::ShowMessage));
    Connect(ID_pref, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(Simple::OnOpen));
    Connect(ID_info, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(Simple::ShowInfo));
    SetMenuBar(menubar);
    Centre();
}
...
void Simple::Select(){
    ...
    tc = new wxTextCtrl(this, -1, wxT(""), wxPoint(0,0), wxSize(250, 30));
    tc1 = new wxTextCtrl(this, -1, wxT(""), wxPoint(0,0), wxSize(250, 30));
    text1 = new wxStaticText(this, wxID_ANY, "Enter User's IP: ", wxPoint (10, 10), wxDefaultSize,
                                                  wxALIGN_CENTRE);
    text2 = new wxStaticText(this, wxID_ANY, "Enter Port: ", wxPoint (10, 10), wxDefaultSize,
                                                  wxALIGN_CENTRE);   
    button = new wxButton(this, ID_start, wxT("Start"));
    Connect(ID_start, wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(Simple::Click2));
    button->SetFocus();
    topsizer->Add(text1, 0, wxEXPAND | wxALL, 15);
    topsizer->Add(tc, 0, wxALIGN_CENTER | wxLEFT | wxRIGHT, 70);
    topsizer->Add(text2, 0, wxEXPAND | wxALL, 15);
...
void Simple::Chat(){
    ...
    delete text2;
    delete button;
    wxStaticText *text1 = new wxStaticText(this, wxID_ANY, "127.0.0.1", wxPoint (10, 10), wxSize(100,20),
                                                  wxALIGN_CENTRE);
    MainEditBox = new wxTextCtrl(this,wxID_ANY, "", wxPoint(-1,-1), wxSize(600, 300),  
    wxTE_MULTILINE | wxTE_RICH , wxDefaultValidator, "");
    wxButton* button1 = new wxButton(this, ID_confirm, wxT("Send"));
    Connect(ID_confirm, wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(Simple::Confirm));
    button1->SetFocus();
    wxButton* button3 = new wxButton(this, ID_file, wxT("Attach File"));
    Connect(ID_file, wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(Simple::OnOpen));
    button3->SetFocus();
    wxButton* button2 = new wxButton(this, ID_clear, wxT("Clear"));
    Connect(ID_clear, wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(Simple::Clear));
    button1->SetFocus();
...
void Simple::ShowMessage(wxCommandEvent& event){
    ...
    wxMessageDialog* dial = new wxMessageDialog(NULL, wxT("Are you sure to quit?"), wxT(""), wxYES_NO | wxNO_DEFAULT | wxICON_QUESTION);
...
void Simple::ShowInfo(wxCommandEvent& event){
    wxMessageDialog* var = new wxMessageDialog(NULL, wxT("Made by Ghost of Vitebsk and Max Qwerty"), wxT(""), wxOK | wxICON_NONE);
    var->ShowModal();
}
...
void Simple::Clear(wxCommandEvent& event){
    MainEditBox->Clear();
}
